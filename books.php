...
if(isset($_POST['add_books'])){
  ...
  try{
    ...
    $booksStatus = 'success';
    $booksMessage = 'Book created successfully.';
 
  }catch (Exception $e) {
 
    $booksStatus = 'error';
    $booksMessage = 'Error creating book.';
    ...
    <div class="col-12 col-lg-4">
      <div class="card p-4">
        ...
        <form action="#" method="POST">
          ...
          <button name="add_books" class="btn btn-primary w-100" type="submit">Save Book</button>
        </form>
      </div>
...
const createStatus = <?php echo json_encode($booksStatus)?>;
const createMessage = <?php echo json_encode($booksMessage)?>;
