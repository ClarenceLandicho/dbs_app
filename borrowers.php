...
$allusers = $con->viewBorrowerusers();
...
$bu_id = $con->insertBorrowerusers($user_id,$borrower_id);
...
if(isset($_POST['add_Address'])){
  ...
  try{
    $ba_id = $con->insertborrowersaddress($borrower_id, $ba_house_number,$ba_street,$ba_barangay,$ba_city,$ba_province,$ba_postal_code,$is_primary);
 
   
 
      $borrowersAddressStatus = 'success';
$borrowersAddressMessage = 'Borrowers address created successfully.';
 
}catch (Exception $e) {
 
  $borrowersAddressStatus = 'error';
$borrowersAddressMessage = 'Error creating borrowers Address.';
          ...
          <div class="card p-4 h-100">
            ...
            <form action="#" method="POST" class="row g-2">
              <div class="col-12">
                ...
                echo '<option value="'.$borrowers['borrower_ID'].'">'.
